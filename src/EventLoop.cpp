...
EventLoop::EventLoop(EventLoop &&eventLoop) noexcept : server(std::move(eventLoop.server)), timer(std::move(eventLoop.timer)),
        epoll(std::move(eventLoop.epoll)), work(std::move(eventLoop.work)) {}
